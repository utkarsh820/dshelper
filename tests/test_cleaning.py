...
class TestCleaning(unittest.TestCase):
    ...
    def test_replace_values(self):
        ...
        # Test with regex
        result = cleaning.replace_values(
            self.df, columns=["C"], to_replace="[aeiou]", value="X", regex=True
        )
    ...
    def test_clean_text(self):
        ...
        result = cleaning.clean_text(
            df_text, columns=["A"], lower=False, strip=True, remove_special=False
        )
    ...
    def test_fix_data_types(self):
        ...
        # Test with specific parameters
        result = cleaning.fix_data_types(
            df_mixed, infer_types=False, numeric_cols=["A", "B"]
        )
        ...
        result = cleaning.fix_data_types(
            df_mixed, infer_types=False, datetime_cols=["C"]
        )
